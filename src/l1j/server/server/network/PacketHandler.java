...
import static l1j.server.server.encryptions.Opcodes.C_OPCODE_BOARDNEXT;
...
import static l1j.server.server.encryptions.Opcodes.C_OPCODE_RESTART2;
...
import l1j.server.server.clientpackets.C_BoardNext;
...
//		String packet = IntArrayUtil.toCsv(ByteArrayUtil.convertToInt(abyte0));
		...
		case C_OPCODE_BOARDNEXT:
			new C_BoardNext(abyte0, _client);
			break;
