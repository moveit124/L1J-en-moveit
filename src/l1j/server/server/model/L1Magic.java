...
public class L1Magic {
	...
	private void commitNpc(int damage, int drainMana) {
		if (_calcType == PC_NPC) {
			...
			if (damage > 0 && _targetNpc instanceof L1MonsterInstance) {
			    L1MonsterInstance monster = (L1MonsterInstance) _targetNpc;
			    monster.addLastAttackedBy(_pc); // ✅ Track last attacker
			}
