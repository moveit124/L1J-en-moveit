...
public class L1ExcludingList {
	...
	/**
	 * Returns a String array of all excluded names
	 */
	...
	/**
	 * Checks if the list contains the specified name
	 */
	...
	/**
	 * Adds a new excluded character by ID and name
	 */
	public void add(int objId, String name) {
		add(name);
	}
}
