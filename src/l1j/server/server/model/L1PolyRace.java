...
import l1j.server.server.command.executor.L1Cancel;
...
public class L1PolyRace {
	...
	public void enterGame(L1PcInstance pc) {
		...
		// ✅ Full cancel clean here
		L1Cancel.fullCancel(pc); // or whatever you named it after moving the method
	}
...
//			}
	...
	private void setGameInit() {
		for (L1PcInstance pc : playerList) {
		    ...
		    // 🛡️ Add here:
		    BotCheckActivityManager.incrementPolyRace(pc); // ✅ Track Poly Race completions
		    pc.addPolyRaceEntry(); // ✅ Check if random Poly Race botcheck needed (with delayed trigger inside)
		}
