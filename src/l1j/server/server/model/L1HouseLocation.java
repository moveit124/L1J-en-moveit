...
public class L1HouseLocation {
	...
	public static int[] getBasementLoc(int houseId) {
		int[] loc = new int[3];
		if (houseId >= 262145 && houseId <= 262189) { //Giran House Basements
			loc[0] = 32768;
			loc[1] = 32832;
			loc[2] = houseId - 257077;
		} else if (houseId >= 327681 && houseId <= 327691) { //Heine House Basements
			loc[0] = 32766;
			loc[1] = 32827;
			loc[2] = houseId - 322568;
		} else if (houseId >= 524289 && houseId <= 524294) { //Aden House Basements
