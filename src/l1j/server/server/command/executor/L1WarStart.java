...
public class L1WarStart implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			StringBuilder msg = new StringBuilder("A siege at " + _l1castle.getName() + " Castle will begin in ");
			if (hours > 0) msg.append(hours).append(" hour").append(hours > 1 ? "s" : "");
			if (hours > 0 && minutes > 0) msg.append(" and ");
			if (minutes > 0) msg.append(minutes).append(" minute").append(minutes > 1 ? "s" : "");
			msg.append(".");

			L1World.getInstance().broadcastPacketToAll(new S_SystemMessage(msg.toString()));
