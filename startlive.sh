...
# Server command
SERVER_CMD="java --add-opens=java.base/jdk.internal.misc=ALL-UNNAMED -Xlog:gc*:file=/opt/classic-363/log/gc.log:time,uptime,level,tags:filecount=10,filesize=100m -javaagent:/opt/classic-363/jmx_prometheus_javaagent-0.16.1.jar=9404:/opt/classic-363/jmx_exporter_config.yaml -Xms4g -Xmx4g -cp l1jen.jar:lib/* l1j.server.Server"
SCREEN_NAME="live"
